...
<body >
	<form action="/zxshow/invest.jsp?tab=4" id="tz3form" method="post">  
		<input type="hidden" id="tbuserid" name="tbuserid" value="1"/>
		<input type="hidden" id="jduserid" name="jduserid" value="2"/>
		<input type="hidden" id="sbuserid" name="sbuserid" value="3"/>
	</form>
</body>
<script type="text/javascript">
	$(function(){
		...
		var sbuserid = '${sbuserid}';
		$("#tbuserid").val(tbuserid);
		$("#jduserid").val(jduserid); 
		$("#sbuserid").val(sbuserid); 
	});
</script>
</html>
